# ChatFlow - Jetpack Compose

Bienvenue dans le projet **ChatFlow**. Ce projet est une démonstration d'une application de messagerie instantanée moderne construite entièrement avec **Jetpack Compose** et **Kotlin**, utilisant **Firebase** comme backend.
